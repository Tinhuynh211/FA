                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class=" manage-bar">
                                    <div class="add">
                                        <button style="justify-content: center;" type="button" class="btn btn-success"><a href="CrudQuestion.jsp">Quản lý</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!--            <div id="addEmployeeModal" class="modal fade">
                                ...
                                <div class="modal-content">
                                    <form id="addQuestionForm">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label>Đáp án (chỉ nhập số từ 1 đến 4)</label>
                                                <input type="number" class="form-control" min="1" max="4" required>
                                            </div>
                                        </div>
                        ...
                        <script>
                            $(document).ready(function () {
                                // Bắt sự kiện khi nhấn vào nút "Thêm câu hỏi"
                                $("#openModalButton").click(function () {
                                    $("#addEmployeeModal").modal('show'); // Hiển thị modal
                                });
                            });
                        </script>-->
        </main><!-- End #main -->
